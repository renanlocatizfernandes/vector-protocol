...
## Repository map
- `ACOMPANHAMENTO_README.md/` — explain what lives here and when agents should edit it.
- `backend/` — explain what lives here and when agents should edit it.
...
- `IMPROVEMENTS_IMPLEMENTED.md/` — explain what lives here and when agents should edit it.
- `kubernetes/` — explain what lives here and when agents should edit it.
