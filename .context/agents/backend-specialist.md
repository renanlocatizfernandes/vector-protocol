...
## Mission
Own backend API and trading engine design; engage for API changes, trading logic, or persistence.
...
- [`WebSocketService`](frontend\src\services\websocket.ts#L5) (class)
