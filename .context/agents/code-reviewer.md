...
## Mission
Review changes for correctness, risks, and standards; engage before merge or when quality is uncertain.
...
- [`TestDataValidator`](backend\tests\test_validations.py#L18) (class)
- [`TestSupervisor`](backend\tests\test_validations.py#L219) (class)
- [`TestSystemStateError`](backend\tests\test_validations.py#L348) (class)
- [`TestDataValidationError`](backend\tests\test_validations.py#L369) (class)
- [`TestIntegration`](backend\tests\test_validations.py#L393) (class)
- [`CmdResult`](backend\scripts\supervisor.py#L84) (class)
- [`StressTestExecutor`](backend\scripts\stress_test_execution.py#L27) (class)
- [`TelegramBot`](backend\modules\telegram_bot.py#L10) (class)
